...
// autogenerated code for double - double from double
 ...
 */
public class MultiArrayDouble extends MultiArray<double[]> { //// codegen: subst:U:Double:Double<U>

    /**
     * @param elements Elements for the new MultiArray
     * @return A MultiArrayDouble1D with the supplied elements
     */
    public static MultiArrayDouble wrap(final double[] elements) { //// codegen: subst:U:U[]:T[] //// subst:U:static:static <T>
     ...
     * @return A MultiArrayDouble1D with the supplied elements
     */
    public static MultiArrayDouble wrap(final double[] elements, final int offset, final int length) { //// codegen: subst:U:U[]:T[] //// subst:U:static:static <T>
     ...
     */
    public static MultiArrayDouble wrap(final double[] elements, final int[] dimensions) { //// codegen: subst:U:U[]:T[] //// subst:U:static:static <T>
     ...
     * @return A MultiArrayDouble or specialisation of it for the 1D and 2D case
     */
    public static MultiArrayDouble wrap(final double[] elements, final int offset, final int[] dimensions) { //// codegen: subst:U:U[]:T[] //// subst:U:static:static <T>
        int nElements = 1;
     ...
     */
    public static MultiArrayDouble allocate(final int[] dimensions) { //// codegen: subst:U:) {:, final Class<T[]> clazz) { //// subst:U:static:static <T>
        switch (dimensions.length) {
            case 1:
                //*// try { //// codegen: subst:U://*// :
                //*//     return new MultiArray1DDouble(clazz.getConstructor(int.class).newInstance(dimensions[0]), dimensions, 0); //// codegen: subst:U://*// :
                ...
                //*// } //// codegen: subst:U://*// :
                return new MultiArray1DDouble(new double[dimensions[0]], dimensions, 0); //// codegen: subst:U:return://*// return
            case 2:
                //*// try { //// codegen: subst:U://*// :
                //*//     return new MultiArray2DDouble(clazz.getConstructor(int.class).newInstance(dimensions[0] * dimensions[1]), dimensions, 0); //// codegen: subst:U://*// :
                //*// } catch (InstantiationException | NoSuchMethodException | IllegalAccessException | java.lang.reflect.InvocationTargetException e) { //// codegen: subst:U://*// :
                //*//     throw new IllegalArgumentException("Could not allocate array for given type", e); //// codegen: subst:U://*// :
                //*// } //// codegen: subst:U://*// :
                //*// try {
                return new MultiArray2DDouble(new double[dimensions[1] * dimensions[0]], dimensions, 0); //// codegen: subst:U:return://*// return
            default:
                int nElements = 1;
                for (int ni : dimensions) {
                    nElements *= ni;
                ...
                //*// try { //// codegen: subst:U://*// :
                //*//     return new MultiArrayDouble(clazz.getConstructor(int.class).newInstance(nElements), dimensions, 0); //// codegen: subst:U://*// :
                //*// } catch (InstantiationException | NoSuchMethodException | IllegalAccessException | java.lang.reflect.InvocationTargetException e) { //// codegen: subst:U://*// :
                //*//     throw new IllegalArgumentException("Could not allocate array for given type", e); //// codegen: subst:U://*// :
                //*// } //// codegen: subst:U://*// :
                return new MultiArrayDouble(new double[nElements], dimensions, 0); //// codegen: subst:U:return://*// return
        }
    }

    protected MultiArrayDouble(final double[] elements, final int[] dimensions, final int offset) { //// codegen: subst:U:double[]:U[]
     ...
     */
    public static class MultiArray1DDouble extends MultiArrayDouble { //// codegen: subst:U:Double:Double<U>

        protected MultiArray1DDouble(final double[] elements, final int[] dimensions, final int offset) { //// codegen: subst:U:double[]:U[]
            super(elements, dimensions, offset);
        }
     ...
     */
    public static class MultiArray2DDouble extends MultiArrayDouble { //// codegen: subst:U:Double:Double<U>

        private final int stride;

        protected MultiArray2DDouble(final double[] elements, final int[] dimensions, final int offset) { //// codegen: subst:U:double[]:U[]
            super(elements, dimensions, offset);
            stride = dimensions[1];
        }
