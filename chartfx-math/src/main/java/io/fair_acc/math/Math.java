...
public class Math extends MathBase {
    ...
    public static float geometricMean(float[] a, int offset, int length) {
        ...
        return (float) Math.exp(logsum / length); //// codegen: returncast all
    }
    ...
    public static int geometricMean(int[] a, int offset, int length) {
        ...
        return (int) Math.exp(logsum / length); //// codegen: returncast all
    }
    ...
    public static long geometricMean(long[] a, int offset, int length) {
        ...
        return (long) Math.exp(logsum / length); //// codegen: returncast all
    }
    ...
    public static short geometricMean(short[] a, int offset, int length) {
        ...
        return (short) Math.exp(logsum / length); //// codegen: returncast all
    }
    ...
    public static boolean isInside(float xp, float yp, int np, float x[], float y[]) {
        ...
        for (int i = 0; i < np; i++) {
            ...
            xint = x[i] + (yp - y[i]) * (xn - x[i]) / ((yn - y[i])); //// codegen: subst:int:/ (:/ ((float)
            if (xp < xint) {
                inter++;
            }
        }
    ...
    public static boolean isInside(int xp, int yp, int np, int x[], int y[]) {
        ...
        for (int i = 0; i < np; i++) {
            ...
            xint = x[i] + (yp - y[i]) * (xn - x[i]) / ((double) (yn - y[i])); //// codegen: subst:int:/ ((double):/ ((double)(int)
            if (xp < xint) {
                inter++;
            }
        }
    ...
    public static float maximum(float[] data, int length) {
        ...
        float val = -Float.MAX_VALUE; //// codegen: subst:int:Int:Integer
        for (int i = 0; i < length; i++) {
            val = Math.max(val, data[i]);
        }
        return val;
    ...
    public static float mean(float[] data, int length) {
        ...
        final float norm = 1.0f / (length); //// codegen: skip int, long, short //// subst:float:1.0f:1.0ff
        float val = 0.0f; //// codegen: skip int, long, short //// subst:float:0.0f:0.0ff
        for (int i = 0; i < length; i++) {
            val += norm * data[i];
        }
        return val; //// codegen: returncast int, long, short
    ...
    public static float median(float[] data, int length) {
        ...
        if (length % 2 == 0) {
            return (float) (0.5 * (temp[length / 2] + temp[length / 2 + 1])); //// codegen: returncast all
        } else {
            return temp[length / 2];
        }
    }
    ...
    public static int maximum(int[] data, int length) {
        ...
        int val = -Integer.MAX_VALUE; //// codegen: subst:int:Integer:Integereger
        for (int i = 0; i < length; i++) {
            val = Math.max(val, data[i]);
        }
        return val;
    ...
    public static int mean(int[] data, int length) {
        ...
        return (int) val; //// codegen: returncast int, long, short
    }
    ...
    public static int median(int[] data, int length) {
        ...
        if (length % 2 == 0) {
            return (int) (0.5 * (temp[length / 2] + temp[length / 2 + 1])); //// codegen: returncast all
        } else {
            return temp[length / 2];
        }
    }
    ...
    public static long maximum(long[] data, int length) {
        ...
        long val = -Long.MAX_VALUE; //// codegen: subst:int:Int:Integer
        for (int i = 0; i < length; i++) {
            val = Math.max(val, data[i]);
        }
        return val;
    ...
    public static long mean(long[] data, int length) {
        ...
        return (long) val; //// codegen: returncast int, long, short
    }
    ...
    public static long median(long[] data, int length) {
        ...
        if (length % 2 == 0) {
            return (long) (0.5 * (temp[length / 2] + temp[length / 2 + 1])); //// codegen: returncast all
        } else {
            return temp[length / 2];
        }
    }
    ...
    public static short maximum(short[] data, int length) {
        ...
        short val = -Short.MAX_VALUE; //// codegen: subst:int:Int:Integer
        for (int i = 0; i < length; i++) {
            val = Math.max(val, data[i]);
        }
        return val;
    ...
    public static short mean(short[] data, int length) {
        ...
        return (short) val; //// codegen: returncast int, long, short
    }
    ...
    public static short median(short[] data, int length) {
        ...
        if (length % 2 == 0) {
            return (short) (0.5 * (temp[length / 2] + temp[length / 2 + 1])); //// codegen: returncast all
        } else {
            return temp[length / 2];
        }
    }
    ...
    public static short peakToPeak(short[] data, int length) {
        ...
        return (short) Math.abs(maximum(data, length) - minimum(data, length)); //// codegen: returncast short
    }
    // end: short
    ...
    public static float rms(float[] data, int length) {
        ...
        val2 *= norm;
        // un-biased rms!
        return (float) sqrt(Math.abs(val2 - val1 * val1)); //// codegen: returncast all
    }
    // end: float
    ...
    public static int rms(int[] data, int length) {
        ...
        val2 *= norm;
        // un-biased rms!
        return (int) sqrt(Math.abs(val2 - val1 * val1)); //// codegen: returncast all
    }
    // end: int
    ...
    public static long rms(long[] data, int length) {
        ...
        val2 *= norm;
        // un-biased rms!
        return (long) sqrt(Math.abs(val2 - val1 * val1)); //// codegen: returncast all
    }
    // end: long
    ...
    public static short rms(short[] data, int length) {
        ...
        val2 *= norm;
        // un-biased rms!
        return (short) sqrt(Math.abs(val2 - val1 * val1)); //// codegen: returncast all
    }
    // end: short
